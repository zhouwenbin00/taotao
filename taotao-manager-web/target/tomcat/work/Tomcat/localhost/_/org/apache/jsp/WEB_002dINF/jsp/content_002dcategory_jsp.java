 ...
 * Generated at: 2019-02-04 08:49:41 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tanimate: true,//动画效果开\r\n");
      out.write("\t\tmethod : \"GET\",//get方式提交\r\n");
      out.write("\t\tfit:true,\r\n");
      out.write("\t\t//当右键点击节点时触发事件\r\n");
      out.write("\t\tonContextMenu: function(e,node){\r\n");
      out.write("\t\t\t//preventDefault() 方法阻止元素发生默认的行为（此处消除默认右键菜单）。\r\n");
      ...
      out.write("            \t\t\t\ttarget : node.target,//更新那个节点\r\n");
      ...
      out.write("                parentId : node.id//新增节点的父节点的id\r\n");
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("        //找到id为0的节点,就是要添加的节点\r\n");
      out.write("\t\tvar _node = tree.tree('find',0);\r\n");
      out.write("\t\t//选择id为0的节点，开启编辑\r\n");
      ...
      out.write("\t\t\t$.messager.alert('提示',\"该分类下面还有内容,删除失败!\")\r\n");
      out.write("\t\t}else{\r\n");
