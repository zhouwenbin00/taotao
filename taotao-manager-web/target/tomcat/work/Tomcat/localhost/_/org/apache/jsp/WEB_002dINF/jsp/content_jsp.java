 ...
 * Generated at: 2019-02-04 08:54:23 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <table class=\"easyui-datagrid\" id=\"contentList\" data-options=\"fit:true,toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'/content/query/list',queryParams:{categoryId:0}\">\r\n");
      out.write("\t\t    <thead>\r\n");
      out.write("\t\t        <tr>\r\n");
      ...
      out.write("\ttree.tree({//创建树\r\n");
      out.write("\t\t//点击树节点时触发\r\n");
      out.write("\t\tonClick : function(node){\r\n");
      out.write("\t\t\t//判断如果点击的是叶子节点\r\n");
      out.write("\t\t\tif(tree.tree(\"isLeaf\",node.target)){\r\n");
      out.write("\t\t\t\t//加载表格中的数据,重新发送url请求加载数据\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('reload', {\r\n");
      out.write("\t\t\t\t\t//发送请求的参数：分类的id\r\n");
